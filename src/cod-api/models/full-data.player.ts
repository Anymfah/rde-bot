...
export class FullDataPlayer {
  ...
  public constructor(dataDto: FullDataDto) {
    ...
    this.shots = data.genericStats.shots;
    this.totalGamesPlayed = data.genericStats.totalGamesPlayed;
    this.totalTimePlayed = data.genericStats.totalTimePlayed;
    ...
    this.weaponStats = JSON.stringify(data.weaponStats);
    ...
    if (sdhcData != null) {
      ...
      this.sd_hc_assists = sdhcData.assists;
      this.sd_hc_mapStats = JSON.stringify(sdhcData.maps);
    }
  }
}
